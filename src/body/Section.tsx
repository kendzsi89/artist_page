...
export default function Section({
  ...
  return (
    <>
      <div
        className={`flex flex-row pt-30 items-center justify-center w-4/5 mx-auto gap-20 ${
      ...
      >
        ...
        {quote && (
          <div className="flex flex-row gap-3 items-baseline">
            ...
            <p className="text-[#444] text-2xl">{quote}</p>
            <Icon
              aStyles="self-end"
              svgStyles="w-15"
        ...
        {paragraph && (
          <div
            className={`flex flex-row gap-5 items-baseline ${additionalStyles}`}
          >
            <p
